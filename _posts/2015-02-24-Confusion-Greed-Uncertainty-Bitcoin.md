...
As I mentioned previously, virtual currencies do <span style="font-weight:bold">not</span> have to have a cap on their quantity. The number <span style="font-style: italic;">Bitcoins</span> might be limited by an asymptotic algorithm but after a recent talk with the very bright <a href="https://www.linkedin.com/profile/view?id=340163807&trk=send_invitation_success_message_name&goback=%2Enpv_340163807_*1_*1_NAME*4SEARCH_TNeI_*1_en*4US_*1_*1_*1_1611648061424769516350_1_2_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_*1_vsrp*4people*4res*4name_*1%2Eint_profile_340163807_Jutta_Steiner_*1_TNeI_NAME*4SEARCH_ajax%3A3226738158189528007_*1_*1_member*4desktop*4profile*4top*5card*5primary_*1" target="_blank">Jutta Steiner</a> who works for the blockchain focused <a href="https://ethereum.org/"  target="_blank">Ethereum Project</a> I learnt that that can be manipulated by changing the algorithm the currency runs on. 
